...
#define MAX1720X_FLAGS_STATUS_DNR             (0x0001U << 0)
#define MAX1720X_FLAGS_STATUS_LONG_RELAX      (0x0001U << 6)
#define MAX1720X_FLAGS_STATUS_FULL_QUALIFIED  (0x0001U << 7)
#define MAX1720X_FLAGS_STATUS_EMPTY_DETECTION (0x0001U << 8)
#define MAX1720X_FLAGS_STATUS_RELAX_DETECTION (0x0001U << 9)

#define MAX1720X_FLAGS_STATUS_SKIP_POR (0x0001U << (32 - 2))
#define MAX1720X_FLAGS_STATUS_HIBERN   (0x0001U << (32 - 1))

/* CONFIG INTERRUPT MASK */
#define MAX1720X_ALERT_MASK_BATTERY_OUT    (0x0001U << 0)
#define MAX1720X_ALERT_MASK_BATTERY_IN     (0x0001U << 1)
#define MAX1720X_ALERT_MASK_ALERT          (0x0001U << 2)
#define MAX1720X_ALERT_MASK_STICKY_VOLTAGE (0x0001U << 12)
#define MAX1720X_ALERT_MASK_STICKY_TEMP    (0x0001U << 13)
#define MAX1720X_ALERT_MASK_STICKY_SOC     (0x0001U << 14)
#define MAX1720X_ALERT_CONFIG1_MASK                                                                \
	(MAX1720X_ALERT_MASK_BATTERY_OUT | MAX1720X_ALERT_MASK_BATTERY_IN |                        \
	 MAX1720X_ALERT_MASK_ALERT | MAX1720X_ALERT_MASK_STICKY_VOLTAGE |                          \
	 MAX1720X_ALERT_MASK_STICKY_TEMP | MAX1720X_ALERT_MASK_STICKY_SOC)

/* CONFIG2 INTERUPT MASK*/
#define MAX1720X_ALERT_MASK_TEMP        (0x0001U << (16 + 6))
#define MAX1720X_ALERT_MASK_SOC_PERCENT (0x0001U << (16 + 7))
#define MAX1720X_ALERT_CONFIG2_MASK     (MAX1720X_ALERT_MASK_TEMP | MAX1720X_ALERT_MASK_SOC_PERCENT)
